...
//                     </div>
//                     <p className="text-muted-textColor">Email: <span className="text-textColor">{user.email}</span></p>
//                     <p className="text-muted-textColor">Name: <span className="text-textColor">{user.name}</span></p>
//                     <p className="text-muted-textColor">Age: <span className="text-textColor">{user.age}</span></p>
//                     <p className="text-muted-textColor">Monthly Income: <span className="text-textColor">{user.monthlyIncome}</span></p>
//                     <p className="text-muted-textColor">Savings Goal: <span className="text-textColor">{user.savingsGoal}</span></p>
//                     <p className="text-muted-textColor capitalize">Persona: <span className="text-textColor">{user.persona || "Not set"}</span></p>
//                     <p className="text-muted-textColor">Income Range: <span className="text-textColor">{user.incomeRange ? INCOME_RANGE_LABELS[user.incomeRange] : "Not set"}</span></p>
//                     <p className="text-muted-textColor">Primary Goal: <span className="text-textColor">{user.primaryGoal ? PRIMARY_GOAL_LABELS[user.primaryGoal] || user.primaryGoal : "Not set"}</span></p>
//                     <div className="gap-4 flex flex-row mt-5 items-center justify-center">
//                         <button onClick={deleteUser} disabled={deletingUser} className="bg-accent text-accent-textColor p-1.5 rounded-lg cursor-pointer w-20">
//                             {deletingUser ? "Deleting..." : "Delete"}
//                         </button>
//                         <button onClick={() => setEditingUser(true)} className="bg-accent text-accent-textColor p-1.5 rounded-lg cursor-pointer w-20">
//                             Edit
//                         </button>
//                     </div>
//                 </div>
